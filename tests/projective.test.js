...
import { pairIntersectsOn, normalizePosition, pairComponentCount, tripleComponentCount, } from "../src/math/intersection";
...
describe("RP²: deck-identified lift-overlap regions (no planar overlap)", () => {
    it("large A contains four ε-images of B: one RP² component, not five", () => {
        ...
        const A = { id: "A", cx: 0, cy: 0, r: 12, color: "#000" };
        const B = { id: "B", cx: 0, cy: 0, r: 2, color: "#000" };
