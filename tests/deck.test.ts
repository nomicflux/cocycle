...
const eps1_proj: DeckElem = { sx: 1, sy: -1, tx: P, ty: 0 };       // (x,y) ↦ (x+P, −y)
const eps2_proj: DeckElem = { sx: -1, sy: 1, tx: 0, ty: P };       // (x,y) ↦ (−x, y+P)
const eps12_proj: DeckElem = { sx: -1, sy: -1, tx: P, ty: -P };    // ε₁∘ε₂
const alpha_klein: DeckElem = { sx: 1, sy: 1, tx: P, ty: 0 };      // T_(P,0)
const beta_klein: DeckElem = { sx: -1, sy: 1, tx: 0, ty: P };      // (x,y) ↦ (−x, y+P)
