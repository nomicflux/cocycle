...
export const presets: Preset[] = [
  ...
  },
  {
    ...
    description:
      "Four discs at x = 2 along the y-axis. In Torus mode the vertical wrap closes a 1-cycle; in Klein bottle the twisted y-wrap flips x, so the wrap intersection is broken — H¹ drops from ℤ to 0.",
    discs: [
      { cx: 2, cy: -4.5, r: 1.6 },
      { cx: 2, cy: -1.5, r: 1.6 },
      { cx: 2, cy: 1.5, r: 1.6 },
  ...
  },
  {
    ...
    description:
      "Four discs at y = 1 across the x-axis. Torus/Klein keep the horizontal wrap and give H¹ = ℤ; in Projective the x-wrap flips y, the wrap intersection is broken — H¹ = 0.",
    discs: [
      { cx: -4.5, cy: 1, r: 1.6 },
      { cx: -1.5, cy: 1, r: 1.6 },
      { cx: 1.5, cy: 1, r: 1.6 },
