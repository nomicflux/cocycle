export const SCENE_EMPTY = { discs: [] };
export const SCENE_TWO_NEAR = {
    discs: [
        { cx: -2.5, cy: 0, r: 1.6, color: "#bbf7d0" },
        { cx: 2.5, cy: 0, r: 1.6, color: "#bfdbfe" },
    ],
};
export const SCENE_THREE_PARTIAL = {
    discs: [
...
export const SCENE_FOUR_SQUARE = {
    discs: [
...
export const SCENE_CIRCLE_TRIANGLE = {
    discs: [
...
export const SCENE_PROJECTIVE_RP2 = {
    space: "projective",
    discs: [
        { cx: -4, cy: -4, r: 3.2, color: "#fecaca" },
        { cx: 0, cy: -4, r: 3.2, color: "#bbf7d0" },
