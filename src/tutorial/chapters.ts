...
export const CHAPTERS: Chapter[] = [
  ...
  },
  {
    ...
    goalHint:
      "On the C¹ card, click › on the 'set c¹ to:' row to load g₁. In the Cup product subsection, set 'basis H^p' to H¹ and pick g₂ from the gen dropdown. The cup result's H² class reads [0]. The goal fires the instant a cup of two H¹ classes on wedge2 lands in B².",
  },
  {
    id: "other-rings",
